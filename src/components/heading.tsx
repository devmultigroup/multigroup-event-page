...
const HighlightHeading: React.FC<HighlightHeadingProps> = ({
  ...
  return (
    <div className="py-16">
      <h2
        className={clsx(
          "font-extrabold text-4xl leading-relaxed mb-4 max-w-2xl mx-auto text-center",
          className,
        )}
      >
        {useHighlightFormat ? (
          <>
            ...
            {highlightText && (
              <span className="bg-color-accent px-4 py-1 rounded-lg">
                {highlightText}
              </span>
            )}
      ...
      {children && (
        <div className="max-w-4xl mx-auto w-5/6">
          <p
            className={clsx(
              "text-lg text-center text-color-text",
              dark && "text-white/80",
            )}
          >
            {children}
