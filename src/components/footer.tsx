...
export default function Footer() {
  ...
  return (
    <footer className="relative text-white py-6 px-2 md:px-12 flex flex-col items-center justify-center min-h-60 bg-color-secondary w-5/6 mx-auto mb-12 rounded-2xl">
